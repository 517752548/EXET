...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ResourcesComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("CacheBundleAsync", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CacheBundleAsync_0);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("LoadSceneActive", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, LoadSceneActive_1);
            args = new Type[]{typeof(System.String)};
        ...
        static StackObject* CacheBundleAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.CacheBundleAsync(@assetBundleName);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* LoadSceneActive_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = instance_of_this_method.LoadSceneActive(@sceneName);
        ...
        static StackObject* GetAsset_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.GetAsset(@assetBundleName);
