...
{
    unsafe class DOTweenAwaiter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::DOTweenAwaiter);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new global::DOTweenAwaiter());


        }

        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref global::DOTweenAwaiter instance_of_this_method)
        {
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            global::DOTweenAwaiter instance_of_this_method = (global::DOTweenAwaiter)typeof(global::DOTweenAwaiter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
