...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETTaskCompletionSource_Binding
    {
        ...
        static StackObject* get_Task_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTaskCompletionSource instance_of_this_method = (ETModel.ETTaskCompletionSource)typeof(ETModel.ETTaskCompletionSource).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
