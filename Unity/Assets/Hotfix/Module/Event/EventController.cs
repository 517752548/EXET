...
namespace ETHotfix
{
    ...
    public class EventController
    {
        ...
        private void OnListenerAdding(string eventType, Delegate listenerBeingAdded)
        {
            ...
            {
                throw new EventException(string.Format("Try to add not correct event {0}. Current type is {1}, adding type is {2}.",
        ...
        private bool OnListenerRemoving(string eventType, Delegate listenerBeingRemoved)
        {
            ...
            {
                throw new EventException(string.Format("Remove listener {0}\" failed, Current type is {1}, adding type is {2}.",
