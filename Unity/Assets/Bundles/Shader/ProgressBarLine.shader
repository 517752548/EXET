Shader "Custom/ProgressBarLine"
{
    Properties
    {
        _BgTex("Background Texture", 2D) = "white" {}
        _MainTex("Progress Texture",2D) = "gray"{}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                {
                    half mask = step(_ProgressValue,IN.texcoord.x);//如果IN.texcoord.y大于_ProgressValue，返回1，小于0.01返回0，用于代替if ,判断是否透明
